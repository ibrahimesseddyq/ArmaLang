(function() {
    ...
    var grammar = {
        ...
        ParserRules: [{
            ...
            {
                "name": "var_assign",
                "symbols": [(myLexer.has("vardec") ? { type: "vardec" } : vardec), "_", (myLexer.has("identifier") ? { type: "identifier" } : identifier), "_", { "literal": "=" }, "_", "expr"],
                "postprocess":
                    (data) => {
                        return {
                            type: "var_assign",
            ...
            {
                "name": "fun_call",
                "symbols": [(myLexer.has("identifier") ? { type: "identifier" } : identifier), "_", { "literal": "(" }, "_ml", "fun_call$ebnf$1", { "literal": ")" }],
                "postprocess":
                    (data) => {
                        return {
                            type: "fun_call",
            ...
            {
                "name": "func_def",
                "symbols": [(myLexer.has("funcdec") ? { type: "funcdec" } : funcdec), "_", (myLexer.has("identifier") ? { type: "identifier" } : identifier), (myLexer.has("lparen") ? { type: "lparen" } : lparen), "_", "func_def$ebnf$1", (myLexer.has("rparen") ? { type: "rparen" } : rparen), "_ml", "lambda_body"],
                "postprocess":
                    (data) => {
                        return {
                            type: "funcdef",
            ...
            {
                "name": "lambda",
                "symbols": [{ "literal": "(" }, "_", "lambda$ebnf$1", { "literal": ")" }, "_", { "literal": "->" }, "_ml", "lambda_body"],
                "postprocess":
                    (data) => {
                        return {
                            type: "lambda",
            ...
            {
                "name": "param_list",
                "symbols": [(myLexer.has("identifier") ? { type: "identifier" } : identifier), "param_list$ebnf$1"],
                "postprocess":
                    (data) => {
            ...
            {
                "name": "lambda_body",
                "symbols": [{ "literal": "{" }, "__lb_", "statements", "__lb_", { "literal": "}" }],
                "postprocess":
                    (data) => {
                        return data[2];
                    }
            },
            { "name": "ifstat", "symbols": [(myLexer.has("ifexp") ? { type: "ifexp" } : ifexp), "expr", { "literal": "{" }, "__lb_", "statements", "__lb_", { "literal": "}" }] },
